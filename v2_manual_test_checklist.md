...
## 3. Manual Test Cases (手工测试用例)

### TC-V2-APP-01: TA applies with a valid note (TA 提交带备注的申请)
...
### TC-V2-APP-02: TA applies with empty note validation (申请备注为空的校验)
...
### TC-V2-TRACK-01: TA checks "My Applications" panel (TA 追踪申请状态)
...
### TC-V2-DECISION-01: MO rejects an applicant (MO 拒绝申请人)
...
### TC-V2-DECISION-02: MO accepts an applicant and job auto-closes (MO 录用且职位自动关闭)
...
### TC-V2-LOCALE-01: Global English Locale consistency (全局语言环境一致性)
...
## 4. Execution Record Template (执行记录)
